		...
		<aside class="side-bar">
			<ul class="nav nav-tabs" role="tablist">
                ...
                <a class="nav-link" data-bs-toggle="tab"
					href="/board/list"><i class="fi fi-rr-lock"> </i>게시판</a>
              </li>
              <li>
                <a class="nav-link" data-bs-toggle="tab"
					href="/admin/userList"><i class="fi fi-rr-rss"> </i>유저관리</a>
              </li>
            </ul>
        </aside>
        <!-- End of Sidebar -->
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div
                                    ...
                                    <div class="card-body">등록된 기사들 (<c:out
													value="${tboardCount.complete}" />)</div>
                                    <div
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div
                                    ...
                                    <div class="card-body">허가된 기사들(<c:out
													value="${tboardCount.permit}" />)</div>
                                    <div
												class="card-footer d-flex align-items-center justify-content-between">
                                        <a
													class="small text-white stretched-link"
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div
                                    ...
                                    <div class="card-body">확인하지않는 기사들 (<c:out
													value="${tboardCount.ready}" />)</div>
                                    <div
												class="card-footer d-flex align-items-center justify-content-between">
                                        <a
													class="small text-white stretched-link"
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div
                                    ...
                                    <div class="card-body">거부된 기사들 (<c:out
													value="${tboardCount.reject}" />)</div>
                                    <div
												class="card-footer d-flex align-items-center justify-content-between">
                                        <a
													class="small text-white stretched-link"
